...
def get_storage_client(media: str, profile: str, s3_endpoint_url: str, etag: bool) -> StorageClient:
    if media.startswith("s3://"):
        return S3Client(media, profile, s3_endpoint_url)
    return FsClient(media, etag)
